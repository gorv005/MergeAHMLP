...
import com.dartmic.mergeahmlp.Name;
...
public class NameAdapter extends ArrayAdapter<Name> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (name.getStatus() == 0)
            imageViewStatus.setBackgroundResource(R.drawable.ic_error_black_24dp);
        else
            imageViewStatus.setBackgroundResource(R.drawable.ic_done_black_24dp);
